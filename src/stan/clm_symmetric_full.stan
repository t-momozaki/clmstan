/**
 * Cumulative Link Model (CLM) - Symmetric Thresholds with Link Parameter Inference
 *
 * Combines symmetric threshold structure with Bayesian inference of link parameters.
 *
 * Symmetric thresholds: c_k = -c_{K-k}
 *
 ...
 *   - clm_symmetric.stan        (symmetric, fixed link params)
...
parameters {
  ...
  // Symmetric threshold parameters
